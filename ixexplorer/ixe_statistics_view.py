...
from ixexplorer.api.ixapi import TclMember, FLAG_RDONLY, FLAG_IGERR, IxTclHalError, ixe_obj_meta
...
class IxeStat(IxeObject, metaclass=ixe_obj_meta):
    ...
    __tcl_members__ = [
        ...
        TclMember('prbsFramesReceived', type=int, flags=FLAG_RDONLY | FLAG_IGERR),
        TclMember('prbsHeaderError', type=int, flags=FLAG_RDONLY | FLAG_IGERR),
